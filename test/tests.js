module.exports = {
  buffer: function (test) {
    ...
    zip.on('end', function() {
      ...
      test.equals(digest, '5641d2b95f2cadaabcc22a7d646bfd41036c347d', 'hex values should match.');
      test.done();
    });
  },
  ...
  store: function (test) {
    ...
    zip.on('end', function() {
      var digest = hash.digest('hex');
      test.equals(digest, 'a777c51ca558e9a2ff36f1f9b7fc70b95560df28', 'hex values should match.');
      test.done();
    });
  }
};